...
#define VENC_MAX_JPEG_ROI_NUM          0

/* For VDEC */
#define VDEC_MAX_CHN_NUM               256
#define VDEC_DEFAULT_LIB               2
...
#define VI_MAX_VIR_CHN_NUM             0
#define VI_MAX_CHN_NUM                 (VI_MAX_PHY_CHN_NUM + VI_MAX_EXT_CHN_NUM + VI_MAX_VIR_CHN_NUM)
...
#define AMIX_MAX_GRP_NUM               2
#define AMIX_MAX_PIPE_NUM              8
#define AMIX_MAX_CHN_NUM               2
