...
RK_S32 RK_MPI_VENC_SetLogCb(void (*logCb)(void *ctx, int level, const char *tag, const char *fmt, const char *func, va_list args));
...
RK_S32 RK_MPI_VENC_SetSpeed(VENC_CHN VeChn, const RK_U32 u32Speed);
RK_S32 RK_MPI_VENC_GetSpeed(VENC_CHN VeChn, RK_U32 *pu32Speed);
RK_S32 RK_MPI_VENC_SetInstBitrateLevel(VENC_CHN VeChn, const RK_U32 u32Level);
RK_S32 RK_MPI_VENC_GetInstBitrateLevel(VENC_CHN VeChn, RK_U32 *pu32Level);
...
RK_S32 RK_MPI_VENC_SendObjDetect(VENC_CHN VeChn, const VENC_OBJ_DETECT_S *pstObjDetect);
...
RK_S32 RK_MPI_VENC_SetJpegRoiAttr(VENC_CHN VeChn, const VENC_JPEG_ROI_ATTR_S *pstJpegRoiAttr);
RK_S32 RK_MPI_VENC_GetJpegRoiAttr(VENC_CHN VeChn, RK_U32 u32Index, VENC_JPEG_ROI_ATTR_S *pstJpegRoiAttr);
...
RK_S32 RK_MPI_VENC_SetSvc3Param(VENC_CHN VeChn, const VENC_SVC3_PARAM_S *pstSvc3Param);
RK_S32 RK_MPI_VENC_GetSvc3Param(VENC_CHN VeChn, VENC_SVC3_PARAM_S *pstSvc3Param);
RK_S32 RK_MPI_VENC_EnableSvc(VENC_CHN VeChn, RK_BOOL bEnable);
RK_S32 RK_MPI_VENC_SetSvcParam(VENC_CHN VeChn, const VENC_SVC_PARAM_S *pstSvcParam);
RK_S32 RK_MPI_VENC_GetSvcParam(VENC_CHN VeChn, VENC_SVC_PARAM_S *pstSvcParam);
RK_S32 RK_MPI_VENC_EnableSvc3(VENC_CHN VeChn, RK_BOOL bEnable, VENC_SUPER_ENCODE_MODE s32Mode, const char *model, void (*cb)(RK_U32 seq, void *result));
RK_S32 RK_MPI_VENC_EnableSvc4(VENC_CHN VeChn, RK_BOOL bEnable);
