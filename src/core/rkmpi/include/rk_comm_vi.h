...
#define VI_VIR_PIPE_ID                (VI_MAX_PHY_PIPE_NUM + VI_MAX_VIR_PIPE_NUM - 1) /* virtual pipe id */
...
/* the param of the ext chn */
typedef struct rkVI_EXT_CHN_ASSIGN_S {
    RK_UCHAR mirrorCmsc;                   /* RW; mirror_cmsc_en 1:miiror_cmsc sel to offline mode, 0:sel to online mode */
    RK_UCHAR extChn[VI_MAX_EXT_CHN_NUM];   /* RW; ch_en 1:channel sel to offline mode, 0:sel to online mode */
} VI_EXT_CHN_ASSIGN_S;
...
typedef struct rVI_MODPARAM_S {
    ...
    union {
        ...
        VI_EXT_CHN_ASSIGN_S  stExtChnParam;
    };
} VI_PARAM_MOD_S;
...
typedef struct rkVI_ISP_OPT_S {
    ...
    RK_CHAR               aEntityName[32];    /* RW;isp capture entity name */
    ...
    RK_BOOL               bAttchFrmInfo;      /* RW;isp frm attach additional info */
} VI_ISP_OPT_S;
...
typedef struct rkVI_FRAME_EXTRA_INFO {
    RK_U64 u64TimeStamp;
    RK_U32 u32Seq;
    RK_U32 u32Hdr;
    RK_U32 u32RollingShutterSkew;
    /* linear or hdr short frame */
    RK_U32 u32SensorExposureTime;
    RK_U32 u32SensorAnalogGain;
    RK_U32 u32SensorDigitalGain;
    RK_U32 u32IspDigitalGain;
    /* hdr mid-frame */
    RK_U32 u32SensorExposureTime_m;
    RK_U32 u32SensorAnalogGain_m;
    RK_U32 u32SensorDigitalGain_m;
    RK_U32 u32IspDigitalGain_m;
    /* hdr long frame */
    RK_U32 u32SensorExposureTime_l;
    RK_U32 u32SensorAnalogGain_l;
    RK_U32 u32SensorDigitalGain_l;
    RK_U32 u32IspDigitalGain_l;
    /* isp reg size: 0x6000 / 4 */
    RK_U32 u32IspReg[6144];
} VI_FRAME_EXTRA_INFO_S;
