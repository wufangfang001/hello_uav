 ...
 * Date  : Apr 8th, 2025
 * Module: AOSL type definition API declaration file
 *
 *
...
#ifndef __AOSL_TYPE_DEF_H__
#define __AOSL_TYPE_DEF_H__
...
typedef struct __c_type_def__ {
	aosl_type_id type_id;
	uint32_t obj_size;
	const char *name;
	uint32_t array_size;
	uint32_t *count_var_addr;
	void *obj_addr;
	const struct __c_type_def__ *child;
} aosl_type_t;
...
extern __aosl_api__ void aosl_init_typed_obj (const aosl_type_t *type, void *typed_obj_p);
extern __aosl_api__ void aosl_fini_typed_obj (const aosl_type_t *type, const void *typed_obj_p);
extern __aosl_api__ aosl_data_t aosl_typed_data (const aosl_type_t *type);

#ifndef _WIN32 /* Not Windows */
extern const aosl_type_t aosl_void_type;
extern const aosl_type_t aosl_int16_type;
extern const aosl_type_t aosl_int32_type;
extern const aosl_type_t aosl_int64_type;
#if defined (__LP64__)
extern const aosl_type_t aosl_int128_type;
#endif
extern const aosl_type_t aosl_float_type;
extern const aosl_type_t aosl_double_type;
extern const aosl_type_t aosl_v4_ipaddr_type;
extern const aosl_type_t aosl_v6_ipaddr_type;
extern const aosl_type_t aosl_string_type;
extern const aosl_type_t aosl_dynamic_bytes_type;
extern const aosl_type_t aosl_dynamic_string_type;
extern const aosl_type_t aosl_dynamic_int16_array_type;
extern const aosl_type_t aosl_dynamic_int32_array_type;
extern const aosl_type_t aosl_dynamic_int64_array_type;
#if defined (__LP64__)
extern const aosl_type_t aosl_dynamic_int128_array_type;
#endif
extern const aosl_type_t aosl_dynamic_float_array_type;
extern const aosl_type_t aosl_dynamic_double_array_type;
extern const aosl_type_t aosl_dynamic_v4_ipaddr_array_type;
extern const aosl_type_t aosl_dynamic_v6_ipaddr_array_type;
#else /* Windows */
/* The nasty MSVC C++ compiler could not support '.mem = val', but its' C compiler does, so just not use the syntax here. */
static const aosl_type_t aosl_void_type = { /*.type_id = */AOSL_TYPE_VOID, /*.obj_size = */0 };
static const aosl_type_t aosl_int16_type = { /*.type_id = */AOSL_TYPE_INT16, /*.obj_size = */sizeof (int16_t) };
static const aosl_type_t aosl_int32_type = { /*.type_id = */AOSL_TYPE_INT32, /*.obj_size = */sizeof (int32_t) };
static const aosl_type_t aosl_int64_type = { /*.type_id = */AOSL_TYPE_INT64, /*.obj_size = */sizeof (int64_t) };
static const aosl_type_t aosl_float_type = { /*.type_id = */AOSL_TYPE_FLOAT, /*.obj_size = */sizeof (float) };
static const aosl_type_t aosl_double_type = { /*.type_id = */AOSL_TYPE_DOUBLE, /*.obj_size = */sizeof (double) };
static const aosl_type_t aosl_v4_ipaddr_type = { /*.type_id = */AOSL_TYPE_V4_IPADDR, /*.obj_size = */4 };
static const aosl_type_t aosl_v6_ipaddr_type = { /*.type_id = */AOSL_TYPE_V6_IPADDR, /*.obj_size = */16 };
static const aosl_type_t aosl_string_type = { /*.type_id = */AOSL_TYPE_STRING, /*.obj_size = */sizeof (char *) };

/* The nasty MSVC C++ compiler could not support '.mem = val', but its' C compiler does, so just not use the syntax here. */
static const aosl_type_t aosl_dynamic_int16_array_type = {
...
static const aosl_type_t aosl_dynamic_int32_array_type = {
	/*.type_id = */AOSL_TYPE_DYNAMIC_ARRAY,
	/*.obj_size = */0,
	/*.name = */NULL,
	/*.array_size = */0,
...
static const aosl_type_t aosl_dynamic_int64_array_type = {
	/*.type_id = */AOSL_TYPE_DYNAMIC_ARRAY,
	/*.obj_size = */0,
	/*.name = */NULL,
	/*.array_size = */0,
...
static const aosl_type_t aosl_dynamic_float_array_type = {
	/*.type_id = */AOSL_TYPE_DYNAMIC_ARRAY,
	/*.obj_size = */0,
	/*.name = */NULL,
	/*.array_size = */0,
...
static const aosl_type_t aosl_dynamic_double_array_type = {
	/*.type_id = */AOSL_TYPE_DYNAMIC_ARRAY,
	/*.obj_size = */0,
	/*.name = */NULL,
	/*.array_size = */0,
...
static const aosl_type_t aosl_dynamic_v4_ipaddr_array_type = {
	/*.type_id = */AOSL_TYPE_DYNAMIC_ARRAY,
	/*.obj_size = */0,
	/*.name = */NULL,
	/*.array_size = */0,
...
static const aosl_type_t aosl_dynamic_v6_ipaddr_array_type = {
	/*.type_id = */AOSL_TYPE_DYNAMIC_ARRAY,
	/*.obj_size = */0,
	/*.name = */NULL,
	/*.array_size = */0,
 ...
 **/
static const aosl_type_t aosl_dynamic_bytes_type = { /*.type_id = */AOSL_TYPE_DYNAMIC_BYTES };
static const aosl_type_t aosl_dynamic_string_type = { /*.type_id = */AOSL_TYPE_DYNAMIC_STRING };
#endif
...
extern __so_api__ int aosl_type_register (const char *name, const aosl_type_t *type);
extern __so_api__ int aosl_type_unregister (const char *name);

#define AOSL_DEFINE_TYPE(name, entry) AOSL_DEFINE_NAMED_ENTRY(type, name, entry)
